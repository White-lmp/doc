import{_ as s,o as n,c as a,O as p}from"./chunks/framework.519a20a1.js";const _=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"views/typescript/typeof.md","filePath":"views/typescript/typeof.md"}'),l={name:"views/typescript/typeof.md"},o=p(`<div class="language-typescript"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// typeof 的作用是把「值空间」的数据转换成「类型空间」的数据。</span></span>
...
<span class="line"><span style="color:#676E95;font-style:italic;"> * }</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;"> */</span></span></code></pre></div>`,1),t=[o];function e(c,r,y,i,D,F){return n(),a("div",null,t)}const A=s(l,[["render",e]]);export{_ as __pageData,A as default};
