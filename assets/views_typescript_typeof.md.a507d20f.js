import{_ as s,o as n,c as a,N as p}from"./chunks/framework.3a447488.js";const _=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"views/typescript/typeof.md"}'),l={name:"views/typescript/typeof.md"},o=p(`<div class="language-typescript"><button title="Copy Code" class="copy"></button><span class="lang">typescript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// typeof 的作用是把「值空间」的数据转换成「类型空间」的数据。</span></span>
